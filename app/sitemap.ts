...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const neighborhoodPages: MetadataRoute.Sitemap = getAllNeighborhoodPages().map((page) => ({
    url: `${baseUrl}/electricien-${page.slug}`,
  ...
  return [...mainPages, ...neighborhoodPages, ...blogPages];
}
